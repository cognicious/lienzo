...
(defcard-rg test-selected-box-arity-1-large
  [select [[:span [:span {:style {:width "20px" :float "right"}} "🇦🇫"] "Afghanistan"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} ""] "Antigua & Deps"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇦🇫"] "Burkina"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇦🇫"] "Central African Rep"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇦🇫"] "Congo"]
