...
(defcard-rg test-selected-box-arity-1-large
  [select [[:span [:span {:style {:width "20px" :float "right"}} "🇦🇫"] "Afghanistan"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇷🇪"] "Réunion"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇧🇱"] "St Barthélemy"]
           [:span [:span {:style {:width "20px" :float "right"}} "🇸🇭"] "St Helena, Ascension and Tristan da Cunha"]
           
           [:span [:span {:style {:width "20px" :float "right"}} "🇰🇳"] "St Kitts & Nevis"]
           [:span [:span {:style {:width "20px" :float "right"}} "🇱🇨"] "St Lucia"]
           [:span [:span {:style {:width "20px" :float "right"}} "🇲🇫"] "St Martin"]
           [:span [:span {:style {:width "20px" :float "right"}} "🇵🇲"] "St Pierre and Miquelon"]
           [:span [:span {:style {:width "20px" :float "right"}} "🇻🇨"] "St Vincent & the Grenadines"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🏴󠁧󠁢󠁳󠁣󠁴󠁿"] "Scotland"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇸🇽"] "Sint Maarten"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇬🇸"] "South Georgia"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇸🇯"] "Svalbard and Jan Mayen"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇹🇱"] "Timor-Leste"]
           
           [:span [:span {:style {:width "20px" :float "right"}} "🇹🇬"] "Togo"]
           [:span [:span {:style {:width "20px" :float "right"}} "🇹🇰"] "Tokelau"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇹🇨"] "Turks and Caicos Islands"]
           ...
           [:span [:span {:style {:width "20px" :float "right"}} "🇺🇲"] "United States Minor Outlying Islands"]
